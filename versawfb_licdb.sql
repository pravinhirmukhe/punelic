...
--
-- Host: localhost
-- Generation Time: Oct 05, 2015 at 07:18 PM
...
CREATE TABLE IF NOT EXISTS `Agent_tbl` (
  `id` int(10) NOT NULL,
  `added_by` enum('Self','Admin') NOT NULL,
  `form_no` varchar(20) NOT NULL,
  `fname` varchar(300) NOT NULL,
  `mname` varchar(300) NOT NULL,
  `lname` varchar(300) NOT NULL,
  `agent_code` varchar(200) NOT NULL,
  `club_membership` varchar(200) NOT NULL,
  `branch` varchar(200) NOT NULL,
  `division` varchar(200) NOT NULL,
  `contact_no` varchar(20) NOT NULL,
  `email` varchar(500) NOT NULL,
  `office_add` varchar(500) NOT NULL,
  `resi_add` varchar(500) NOT NULL,
  `area` varchar(100) NOT NULL,
  `city` varchar(100) NOT NULL,
  `state` varchar(100) NOT NULL,
  `pincode` varchar(6) NOT NULL,
  `agency_since` date NOT NULL,
  `oth_busi` varchar(300) NOT NULL,
  `date_reg` date NOT NULL,
  `photo` text NOT NULL,
  `type` enum('DO','Agent') NOT NULL,
  `status` enum('Active','Deactive') NOT NULL DEFAULT 'Deactive'
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `Agent_tbl`
--

INSERT INTO `Agent_tbl` (`id`, `added_by`, `form_no`, `fname`, `mname`, `lname`, `agent_code`, `club_membership`, `branch`, `division`, `contact_no`, `email`, `office_add`, `resi_add`, `area`, `city`, `state`, `pincode`, `agency_since`, `oth_busi`, `date_reg`, `photo`, `type`, `status`) VALUES
(1, 'Self', '100001', 'sdfgs', 'dfgsdf', 'gsdfg', 'sdfgsdf', 'sdfgsdf', 'gsdfg', 'sdfg', '12548578546', 'a@gmail.com', 'dfgsdf', 'gsdfgsdfg', '', 'Pune', 'Maharashtra', '345343', '2000-05-10', 'DFGHDFGH', '2015-10-04', '{"name":"specialreports_2edb_katrina-kaif-.jpg","type":"image/jpeg","tmp_name":"/opt/lampp/temp/phplYhH2T","error":0,"size":98445}', 'Agent', 'Deactive'),
(2, 'Self', '100002', 'SDFG', 'HJ', 'HKNM', 'A121', '12er', 'sdgnjk', 'sdfnkl', '9028857725', 'bhimsen@gmail.com', 'dkjfsdj', 'kbsjdkbj', '', 'Solapur', 'Maharashtra', '123456', '0000-00-00', 'jdskbf', '2015-10-04', '{"name":"logo.png","type":"image/png","tmp_name":"/opt/lampp/temp/phpJACnrc","error":0,"size":8490}', 'Agent', 'Deactive');
...
INSERT INTO `area` (`id`, `prof_id`, `area`, `create_date`, `modify_date`, `status`) VALUES
(1, 1, 'dfgsdf', '2015-10-04 04:31:24', '0000-00-00 00:00:00', 'Active'),
(2, 1, 'dfgsdfg', '2015-10-04 04:31:24', '0000-00-00 00:00:00', 'Active'),
(3, 1, 'dfgsdfgs', '2015-10-04 04:31:24', '0000-00-00 00:00:00', 'Active'),
(4, 2, 'Solapur', '2015-10-04 06:09:00', '0000-00-00 00:00:00', 'Active'),
(5, 2, 'BHIUI', '2015-10-04 06:09:00', '0000-00-00 00:00:00', 'Active');
...
(320, 'Amli', 'Dadra and Nagar Haveli'),
(321, 'Silvassa', 'Dadra and Nagar Haveli'),
(322, 'Daman and Diu', 'Daman and Diu'),
(323, 'Daman and Diu', 'Daman and Diu'),
(324, 'Asola', 'Delhi'),
(325, 'Delhi', 'Delhi'),
(326, 'Aldona', 'Goa'),
...
(331, 'Marmagao', 'Goa'),
(332, 'Panaji', 'Goa'),
(333, 'Ahmedabad', 'Gujrat'),
(334, 'Amreli', 'Gujrat'),
(335, 'Anand', 'Gujrat'),
(336, 'Ankleshwar', 'Gujrat'),
(337, 'Bharuch', 'Gujrat'),
(338, 'Bhavnagar', 'Gujrat'),
(339, 'Bhuj', 'Gujrat'),
(340, 'Cambay', 'Gujrat'),
(341, 'Dahod', 'Gujrat'),
(342, 'Deesa', 'Gujrat'),
(343, '"Dharampur', ' India'),
(344, 'Dholka', 'Gujrat'),
(345, 'Gandhinagar', 'Gujrat'),
(346, 'Godhra', 'Gujrat'),
(347, 'Himatnagar', 'Gujrat'),
(348, 'Idar', 'Gujrat'),
(349, 'Jamnagar', 'Gujrat'),
(350, 'Junagadh', 'Gujrat'),
(351, 'Kadi', 'Gujrat'),
(352, 'Kalavad', 'Gujrat'),
(353, 'Kalol', 'Gujrat'),
(354, 'Kapadvanj', 'Gujrat'),
(355, 'Karjan', 'Gujrat'),
(356, 'Keshod', 'Gujrat'),
(357, 'Khambhalia', 'Gujrat'),
(358, 'Khambhat', 'Gujrat'),
(359, 'Kheda', 'Gujrat'),
(360, 'Khedbrahma', 'Gujrat'),
(361, 'Kheralu', 'Gujrat'),
(362, 'Kodinar', 'Gujrat'),
(363, 'Lathi', 'Gujrat'),
(364, 'Limbdi', 'Gujrat'),
...
(366, 'Mahesana', 'Gujrat'),
(367, 'Mahuva', 'Gujrat'),
(368, 'Manavadar', 'Gujrat'),
(369, 'Mandvi', 'Gujrat'),
(370, 'Mangrol', 'Gujrat'),
(371, 'Mansa', 'Gujrat'),
(372, 'Mehmedabad', 'Gujrat'),
(373, 'Modasa', 'Gujrat'),
(374, 'Morvi', 'Gujrat'),
(375, 'Nadiad', 'Gujrat'),
(376, 'Navsari', 'Gujrat'),
...
(381, 'Patan', 'Gujrat'),
(382, 'Petlad', 'Gujrat'),
(383, 'Porbandar', 'Gujrat'),
(384, 'Radhanpur', 'Gujrat'),
(385, 'Rajkot', 'Gujrat'),
(386, 'Rajpipla', 'Gujrat'),
(387, 'Rajula', 'Gujrat'),
(388, 'Ranavav', 'Gujrat'),
...
--
-- Dumping data for table `formgen`
--

INSERT INTO `formgen` (`formno`) VALUES
('100002');
...
INSERT INTO `system_user` (`id`, `name`, `username`, `pass`, `status`) VALUES
