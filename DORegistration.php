...
<tr><td>D.O. Code :</td><td><input type="text" value="" class="form-control" name="txtAgentCode" placeholder="Enter Agent Code"></td></tr>
...
<tr><td><b>Branch </b></td><td><input type="text" value="" class="form-control" name="txtBranch"placeholder="Enter year Branch"></td></tr>
<tr><td>Division : </td><td><input type="text" value="" class="form-control" name="txtDivision"placeholder="Enter Division"></td></tr>

<tr><td>Contact Number: </td><td><input type="text" value="" class="form-control" name="txtContact"placeholder="Enter Contact Number"></td></tr>
<tr><td>Email : </td><td><input type="text" value="" class="form-control" name="txtEmail" placeholder="Enter Email"></td></tr>
<tr><td>Area :</td><td><input type="text" value="" class="form-control" name="txtArea" placeholder="Enter Area"></b></td></tr>
...
$sql="insert into Officer_tbl (DoCode,Name,ClubMember,Branch,Division,Contact,Email,Area,AgencySince,OfficeAddr,ResAddr,Description,Date) values('$ac','$nm','$cm','$br','$di','$cnt','$em','$ar','$as','$oa','$ra','$de','".date("Y-m-d")."')";
