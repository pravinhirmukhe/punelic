...
<!--Start Message code-->
	...
	function submitVal(){
		...
		// jQuery REST trial
		$.ajax({
    	url: 'http://103.16.101.52:8080/sendsms/bulksms?username=pit6-imatessms&password=imatessm&type=0&dlr=1&destination=919860269054&source=imates&message=PuneLicAgents Agent Enquiry %0AName: '+username+'%0AContact No.: '+mobileNumber,
    	type: 'POST',
